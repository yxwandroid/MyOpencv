...
public class SiftActivity extends BaseActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_sift, menu);
        return true;
    }
...
//                        ivImage1.setImageBitmap(selectedImage);
        ...
        Toast.makeText(SiftActivity.this, src1Selected + " " + src2Selected, Toast.LENGTH_SHORT).show();
...
//        Features2d.drawMatches(src1, keypoints1, src2, keypoints2, matches, src3);
        ...
        boolean bool = Imgcodecs.imwrite(Environment.getExternalStorageDirectory()+"/Download/PacktBook/Chapter3/"+ACTION_MODE+".png", src3);
    ...
    static Mat drawMatches(Mat img1, MatOfKeyPoint key1, Mat img2, MatOfKeyPoint key2, MatOfDMatch matches, boolean imageOnly){
        ...
        Imgproc.putText(out, "MATCHED", new Point(img1.width() + img2.width() / 2,30), Core.FONT_HERSHEY_PLAIN, 2, new Scalar(255,0,0),3);
        return out;
    }
